...
<head>
  ...
  <title>Posyandu Laccori - Login</title>
  <!-- Simple bar CSS -->
...
<body class="light ">
  <div class="wrapper vh-100">
    <div class="row align-items-center h-100">
      <form class="col-lg-4 col-md-4 col-10 mx-auto text-center" action="{{ route('puskesmas.login.check') }}"
        method="post">
        @csrf
        ...
        <h1 class="h4 mb-3">Login Puskesmas</h1>
