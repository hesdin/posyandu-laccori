...
<head>
  ...
  <title>Posyandu Laccori - Login User</title>
  <!-- Simple bar CSS -->
...
<body class="light ">
  <div class="wrapper vh-100">
    <div class="row align-items-center h-100">
      ...
      <form class="col-lg-4 col-md-4 col-10 mx-auto text-center" action="{{ route('login.check') }}" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" id="no_kk" class="form-control form-control-lg" placeholder="No KK" required=""
            autofocus="" name="no_kk">
        </div>
        <div class="form-group">
