    ...
    <ul class="navbar-nav flex-fill w-100 mb-2">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="list-unstyled pl-4 w-100 collapse" id="input" style="">
          ...
          <li class="nav-item">
            <a class="nav-link pl-3" href="{{ route('admin.ibu-hamil.index') }}"><span class="ml-1 item-text">Input Data
                Ibu Hamil</span></a>
          </li>
          <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="list-unstyled pl-4 w-100 collapse" id="laporan" style="">
          <li class="nav-item">
            <a class="nav-link pl-3" href="{{ route('admin.posyandu.balita') }}"><span class="ml-1 item-text">Balita
                Posyandu</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link pl-3" href="{{ route('admin.laporan.ibu.hamil') }}"><span
