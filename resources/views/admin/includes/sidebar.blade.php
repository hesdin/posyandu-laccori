    ...
    <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="list-unstyled pl-4 w-100 collapse" id="input" style="">
                    ...
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('keluarga.index') }}"><span class="ml-1 item-text">Input
                                Data Keluarga</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('ibu-hamil.index') }}"><span
                                class="ml-1 item-text">Input Data
                                Ibu Hamil</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('balita.index') }}"><span class="ml-1 item-text">Input
                                Data
                                Balita</span></a>
                    </li>
                </ul>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="list-unstyled pl-4 w-100 collapse" id="data" style="">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('balita-posyandu.index') }}"><span
                                class="ml-1 item-text">Balita
                                Posyandu</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('pemeriksaan-ibu-hamil.index') }}"><span
        ...
        <div class="btn-box w-100 mt-4 mb-1">
            <a href="https://themeforest.net/item/tinydash-bootstrap-html-admin-dashboard-template/27511269"
                target="_blank" class="btn mb-2 btn-danger btn-md btn-block">
