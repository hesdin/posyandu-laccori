                      ...
                      <tbody>
                        @foreach ($data_ibu_hamil as $ibu_hamil)
                          <tr role="row" class="odd">
                            ...
                            <td>
                              @if (!empty($ibu_hamil->user->balita->nama))
                                <span class="badge badge-primary" style="font-size: 13px">Nifas</span>
                              @else
                            ...
                            <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button"
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <form id="form{{ $ibu_hamil->id }}"
                                  action="{{ route('admin.ibu-hamil.destroy', $ibu_hamil->id) }}" method="post">
                                  @csrf
                                  @method('DELETE')
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group mb-3" data-select2-id="13">
                    ...
                    <select class="form-control select2 select2-hidden-accessible" id="simple-select2"
                      data-select2-id="simple-select2" tabindex="-1" aria-hidden="true" name="user_id">
