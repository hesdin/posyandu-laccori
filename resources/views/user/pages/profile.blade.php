                ...
                <form action="{{ route('profile.update', auth()->user()->id) }}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="simpleinput" class="form-control" value="{{ auth()->user()->no_kk }}"
                                readonly>
                        </div>

                        <div class="form-group mb-3">
                            <label for="simpleinput">Kepala Keluarga</label>
                            <input type="text" id="simpleinput" class="form-control" value="{{ auth()->user()->nama }}"
                                readonly>
                        </div>

                        @if (auth()->user()->ibuHamil()->exists())
                            <div class="form-group mb-3">
                                <label for="simpleinput">Istri Hamil</label>
                                <input type="text" id="simpleinput" class="form-control"
                                    value="{{ auth()->user()->ibuHamil->nama }}" readonly>
                            </div>
                        @endif
                        ...
                        @if (auth()->user()->balita()->exists())
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="simpleinput" class="form-control"
                                    value="{{ auth()->user()->balita->nama }}" readonly>
                            </div>
                        @endif
                        <div class="form-group mb-3">
