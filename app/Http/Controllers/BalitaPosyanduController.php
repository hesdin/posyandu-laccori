...
class BalitaPosyanduController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    if ($save) {
      return redirect()->route('balita-posyandu.show', $balita_posyandu->balita_id)->with('success', 'Data berhasil ditambahkan');
    } else {
      dd('error');
    }
  }
  ...
  public function update(Request $request, $id)
  {
    ...
    if ($save) {
      return redirect()->route('balita-posyandu.show', $posyandu->balita_id)->with('success', 'Data berhasil diubah');
    } else {
      dd('gagal');
    }
  }
